...
if "Python" in text:
    ...
    print("The text doesn't contain 'Python'.")
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
if "Java" in text:
    print("The text contains 'Java'.")
else:
    print("The text doesn't contain 'Java'.")
# CODUL TĂU VINE MAI SUS:
...
if "Python" in text:
    ...
    print("The text doesn't contain 'Python' or 'Java'.")
# CODUL TĂU VINE MAI SUS:
...
if 'Python' in text and 'Java' in text:
    print("The text contains 'Java' and 'Python'.")
elif "Python" in text:
    print("The text contains 'Python'.")
elif "Java" in text:
    print("The text contains 'Java'.")
...
# CODUL TĂU VINE MAI JOS:
number = int(input("Choose a nr from 1 to 5: "))
