...
class Telefon(Produs):
    def __init__(self, name, price, year, baterie_mAh, memorie_GB):
...
# CODUL TĂU VINE MAI JOS:
class Laptop(Produs):
    def __init__(self, name, price, year, sistem_de_operare, procesor):
        super().__init__(name, price, year)
...
class Trotineta(Produs):
    def __init__(self, name, price, year, viteza_maxima, autonomie_km):
        super().__init__(name, price, year)
...
class AppleProduct(Produs):
    def __init__(self, name, price, year, color, produs_conectat="nimic"):
        super().__init__(name, price, year)
        self.culoare = color
